...
import { AlertTriangle, Check, Eye, Bell, BellOff, Brain } from "lucide-react";
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    ...
                    {onExplain && (
                      <Button
                        variant="ghost"
                        size="sm"
                        className="h-7 text-xs text-[#76B900] hover:text-[#76B900]/80"
                        onClick={() => onExplain(alert)}
                        data-testid={`button-explain-alert-${alert.id}`}
                      >
